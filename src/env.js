...
// src/env.js
export const API_URL = window._env_?.REACT_APP_API_URL || 'https://onnoto-backend-57045655083.us-central1.run.app/api';
...
export const WS_URL = window._env_?.REACT_APP_WS_URL || 'wss://onnoto-backend-57045655083.us-central1.run.app/ws';
